...
func Register(mux *http.ServeMux, appState *state.State) {
	...
	mux.Handle("/auth/roblox", http.HandlerFunc(h.streamerConnect))
}
...
func (h handler) streamerConnect(w http.ResponseWriter, r *http.Request) {
	...
	url, err := h.appState.RobloxOAuth.StreamerConnectURL(r.Context())
	if err != nil {
...
func (h handler) enabled() bool {
	return h.appState != nil && h.appState.Config != nil && h.appState.Config.Roblox.Enabled
}
